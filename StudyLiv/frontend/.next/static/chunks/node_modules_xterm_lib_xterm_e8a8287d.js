...
"[project]/node_modules/xterm/lib/xterm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
                ...
                let f = t.DomRendererRowFactory = class {
                    ...
                    createRow(e, t, i, s, r, a, h, l, _, f, p) {
                        ...
                        for(let M = 0; M < b; M++){
                            ...
                            if (I.isBold() && B.push("xterm-bold"), I.isItalic() && B.push("xterm-italic"), I.isDim() && B.push("xterm-dim"), w = I.isInvisible() ? o.WHITESPACE_CELL_CHAR : I.getChars() || o.WHITESPACE_CELL_CHAR, I.isUnderline() && (B.push("xterm-underline-".concat(I.extended.underlineStyle)), " " === w && (w = " "), !I.isUnderlineColorDefault())) if (I.isUnderlineColorRGB()) C.style.textDecorationColor = "rgb(".concat(u.AttributeData.toColorRGB(I.getUnderlineColor()).join(","), ")");
                            else {
