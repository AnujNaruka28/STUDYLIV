...
const ContentSidebar: React.FC<{ courseContent: Section[] }> = ({ courseContent }) => {
    ...
    return (
        <div className='w-full lg:w-[20%] max-h-full bg-[var(--richblack-800)] border-t lg:border-t-0 lg:border-r border-solid border-[var(--richblack-700)]
        pt-[16px] lg:pt-[32px] flex flex-col gap-2.5 overflow-y-scroll transition-all duration-300 ease-in-out'>
            ...
            <header className='w-full h-[10%] py-2 px-4 lg:px-6 gap-2 flex flex-col lg:flex-row lg:items-center'>
            ...
            <div className='w-full h-[10%] py-2 px-2 border-t border-solid border-[var(--richblack-600)] flex items-center justify-center'>
